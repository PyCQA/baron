...
def test_float_exponent():
    match('1234e10', 'FLOAT_EXPONENT')
    match('1234E10', 'FLOAT_EXPONENT')
    match('1234e+10', 'FLOAT_EXPONENT')
    match('1234e-10', 'FLOAT_EXPONENT')
    match('1234E+10', 'FLOAT_EXPONENT')
    match('1234E-10', 'FLOAT_EXPONENT')
    match('1234.5678e10', 'FLOAT_EXPONENT')
    match('1234.5678E10', 'FLOAT_EXPONENT')
    match('1234.5678e+10', 'FLOAT_EXPONENT')
    match('1234.5678e-10', 'FLOAT_EXPONENT')
    match('1234.5678E+10', 'FLOAT_EXPONENT')
    match('1234.5678E-10', 'FLOAT_EXPONENT')
    match('.5678e10', 'FLOAT_EXPONENT')
    match('.5678E10', 'FLOAT_EXPONENT')
    match('.5678e+10', 'FLOAT_EXPONENT')
    match('.5678e-10', 'FLOAT_EXPONENT')
    match('.5678E+10', 'FLOAT_EXPONENT')
    match('.5678E-10', 'FLOAT_EXPONENT')
...
def test_float_exponent_advanced():
    match("1E1", "FLOAT_EXPONENT")
    match("1E-2", "FLOAT_EXPONENT")
    match("1E+2", "FLOAT_EXPONENT")
    match("1.E1", "FLOAT_EXPONENT")
    match(".1E1", "FLOAT_EXPONENT")
    match("1e1", "FLOAT_EXPONENT")
    match("1e-2", "FLOAT_EXPONENT")
    match("1e+2", "FLOAT_EXPONENT")
...
def test_exponent_complex():
    ...
    match("1.e1j", "FLOAT_EXPONENT_COMPLEX")
    match("1.1e1j", "FLOAT_EXPONENT_COMPLEX")
    match(".1e1j", "FLOAT_EXPONENT_COMPLEX")
    match("-1.e1j", "FLOAT_EXPONENT_COMPLEX")
    match("-1.1e1j", "FLOAT_EXPONENT_COMPLEX")
    match("-.1e1j", "FLOAT_EXPONENT_COMPLEX")
    match("1e-1j", "FLOAT_EXPONENT_COMPLEX")
    match("1.e-1j", "FLOAT_EXPONENT_COMPLEX")
    match("1.1e-1j", "FLOAT_EXPONENT_COMPLEX")
    match(".1e-1j", "FLOAT_EXPONENT_COMPLEX")
    match("-1.e-1j", "FLOAT_EXPONENT_COMPLEX")
    match("-1.1e-1j", "FLOAT_EXPONENT_COMPLEX")
    match("-.1e-1j", "FLOAT_EXPONENT_COMPLEX")
