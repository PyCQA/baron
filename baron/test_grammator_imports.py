#!/usr/bin/python
# -*- coding:Utf-8 -*-
from test_utils import parse_simple, space, name, importeu, dotted_as_name, from_import, name_as_name
...
def test_simple_import():
    ...
    parse_simple([
           ...
           ('NAME', 'pouet')],
          [importeu([
                     dotted_as_name({ "type": "dotted_name", "value": [name("pouet")], })
                    ],
                    space="  ")])
...
def test_import_basic_dot():
    ...
    parse_simple([
           ...
           ('NAME', 'blob')],
          [importeu([
                     dotted_as_name({ "type": "dotted_name", "value": [                                                  name("pouet"),                                                  { "type": "dot", "value": ".", },                                                  name("blob")                                                 ], }
                                   )
                    ],
                    space="  "
                   )])
...
def test_import_more_dot():
    ...
    parse_simple([
           ...
           ('NAME', 'plop')],
          [importeu([
                     dotted_as_name({ "type": "dotted_name", "value": [                                                  name("pouet"),                                                  { "type": "dot", "value": ".", },                                                  name("blob"),                                                  space(" "),                                                  { "type": "dot", "value": ".", },                                                  name("plop")                                                 ], }
                                   )
                    ],
                    space="  ")])
    parse_simple([
...
def test_import_a_b():
    ...
    parse_simple([
           ...
           ('NAME', 'b')],
          [importeu([
                     dotted_as_name({ "type": "dotted_name", "value": [name('a')], }),
                     { "type": "comma", "value": ",", },
                     space(),
                     dotted_as_name({
                        "type": "dotted_name",
    ...
    parse_simple([
          ...
          [importeu([
                     ...
                     { "type": "comma", "value": ",", },
                     space(),
                     dotted_as_name({ "type": "dotted_name", "value": [name('b')], })
                    ],
                    space=" ")])
...
def test_import_a_b_as_c():
    ...
    parse_simple([
          ...
          [importeu([
                    ...
                    space(),
                    dotted_as_name(
                                    { "type": "dotted_name", "value": [                                                  name('b'),                                                  { "type": "dot", "value": ".", },                                                  name('d')                                                 ], },
                                    as_=True,
                                    before_space=" ",
                                    after_space="  ",
                                    target="c"
...
def test_import_a_b_c_d():
    ...
    parse_simple([
          ...
          [importeu([
                     ...
                     { "type": "comma", "value": ",", },
                     space(),
                     dotted_as_name({ "type": "dotted_name", "value": [name('c')], }),
                     { "type": "comma", "value": ",", },
                     space(),
                     dotted_as_name({
                        "type": "dotted_name",
    ...
    parse_simple([
          ...
          [importeu([
                     ...
                     { "type": "comma", "value": ",", },
                     space(),
                     dotted_as_name({ "type": "dotted_name", "value": [name('d')], })
                    ],
                    space=" "
                   )])
    parse_simple([
...
def test_from_a_dot_c_import_b():
    ...
    parse_simple([
           ...
           ('NAME', 'b')],
          [from_import(
                       { "type": "dotted_name", "value": [                                     name('a'),                                     { "type": "dot", "value": ".", },                                     name('c')                                    ], },
                       targets=[
                                name_as_name('b')
                               ]
                      )])
...
def test_from_dot_a_import_b():
    ...
    parse_simple([
          ...
          [from_import(
                       { "type": "dotted_name", "value": [                                     { "type": "dot", "value": ".", },                                     name('a')                                    ], },
                       targets=[
                                name_as_name('b')
                               ]
                      )])
...
def test_from_dot_dot_dot_a_import_b():
    ...
    parse_simple([
          ...
          [from_import(
                       { "type": "dotted_name", "value": [                                     { "type": "dot", "value": ".", },                                                  { "type": "dot", "value": ".", },                                                  { "type": "dot", "value": ".", },                                     name('a')                                    ], },
                       targets=[
                                name_as_name('b')
                               ]
                      )])
...
def test_from_no_space_dot_a_import_b():
    ...
    parse_simple([
          ...
          [from_import({ "type": "dotted_name", "value": [                                     { "type": "dot", "value": ".", },                                     name('a')                                    ], },
                       targets=[
                                name_as_name('b')
                               ],
                       before_space=""
