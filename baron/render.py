...
nodes_rendering_order = {
        ...
        "def": [
            ...
            ("formatting", "fourth_formatting", True),
            ("constant",   ")",                 True),
            ("formatting", "before_rarrow_formatting",  "annotation"),
            ("constant",   "->",                "annotation"),
            ("formatting", "after_rarrow_formatting",  "annotation"),
        ...
        "def_argument": [
            ("key",        "target",            True),
            ("formatting", "before_colon_formatting",  "annotation"),
            ("constant",   ":",                 "annotation"),
            ("formatting", "after_colon_formatting", "annotation"),
            ("list",       "annotation",        "annotation"),
